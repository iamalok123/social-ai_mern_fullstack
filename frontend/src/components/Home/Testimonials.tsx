...
const testimonials = [
    {
        ...
        text: "Social AI has saved our team 10+ hours a week. The AI composer is genuinely impressive — it writes content that sounds like us.",
    },
    {
        name: "Marcus L.",
        role: "Indie Creator",
    ...
    },
    {
        ...
        text: "Finally a tool that's beautiful AND powerful. The clean dashboard makes it easy to see exactly what's going out and when.",
    },
];
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-gray-900 dark:text-white">
                        Loved by <span className="text-red-400 dark:text-orange-500">creators &amp; teams</span>
                    </h2>
                    <p className="mt-5 text-gray-500 dark:text-zinc-400 max-w-md mx-auto">Join thousands of people who automate their social media with Social AI.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {testimonials.map((t, i) => (
                        <div key={i} className="bg-white dark:bg-zinc-950 rounded-2xl border border-slate-100 dark:border-zinc-800 hover:border-slate-200 dark:hover:border-orange-500/40 hover:shadow-lg dark:hover:shadow-orange-500/5 p-6 transition-all flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-3 pt-2 border-t border-slate-100 dark:border-zinc-800">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-slate-400 dark:text-zinc-400">{t.role}</div>
                                </div>
                            </div>
                        </div>
                    ))}
